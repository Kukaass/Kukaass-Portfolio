    ...
    return(
        <div className="pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09101a]">
            ...
            <div className="w-[80%] mx-auto pt-[4rem] md:pt-[8rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center">
                <div>
                    <SkillsItem title="React Developer" year="20&& - 20&&"/>
                    <SkillsItem title="Angular Developer" year="20&& - 20&&"/>
                    <SkillsLanguage skill1="HTML" skill2="CSS" skill3="Javascript" level1="w-[91%]" level2="w-[88%]" level3="w-[80%]"/>
                </div>
                <div>
                    <SkillsItem title="Node JS Developer" year="20&& - 20&&"/>
                    <SkillsItem title="Next JS Developer" year="20&& - 20&&"/>
